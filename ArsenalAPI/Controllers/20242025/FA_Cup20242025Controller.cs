...
{
    public class FA_Cup20242025Controller : ApiController
    {
        // GET: api/FA_Cup
        public HttpResponseMessage Get()
        {
            string query = @"
                EXEC SelectFACupData
            ";
        ...
        public string Delete(int id)
        {
            try
            {
                DataTable table = new DataTable();
                string query = @"
                          delete from dbo.FA_Cup where PlayerID = " + id;
